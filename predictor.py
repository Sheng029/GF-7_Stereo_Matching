...
if __name__ == '__main__':
    memory = your GPU memory
    filepath1 = name of your left image
    filepath2 = name of your right image
    height, width = 2048, 2048   # fixed
    model_dir = 'DSMNet' or 'StereoNet'
    save_dir = directory to save pyramid disparity results
    filepath = name of final disparity
